...
## (kg39) ericsali@erics-MacBook-Pro-4 gnn_pathways % python __embedding_omics_cpdb_ppi/gat_embedding.py --out_feats 300 --num_layers 2 --num_heads 2 --batch_size 1 --lr 0.001 --num_epochs 27
# (kg39) ericsali@erics-MacBook-Pro-4 gnn_pathways % python __embedding_omics_cpdb_ppi/gat_embedding.py --out_feats 256 --num_layers 2 --num_heads 2 --batch_size 1 --lr 0.001 --num_epochs 10 
...
## python gat_embedding.py --out_feats 128 --num_layers 3 --num_heads 2 --batch_size 1 --lr 0.0001 --num_epochs 2002
